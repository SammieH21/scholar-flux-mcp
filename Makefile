...
# Persist history in `~/.scholar_flux/package_cache` directory or fallback dir when possible
SCHOLAR_FLUX_MCP_PERSIST_HISTORY ?= true
## Direct override for the history storage location. HistoryService converts `"None"` (string) into `None`
SCHOLAR_FLUX_MCP_HISTORY_URL ?= None
...
SCHOLAR_FLUX_MCP_ENABLE_LOGGING ?= true
...
mcp:
	...
	npx @modelcontextprotocol/inspector \
        ...
        -e SCHOLAR_FLUX_MCP_PERSIST_HISTORY=${SCHOLAR_FLUX_MCP_PERSIST_HISTORY} \
        ...
        -e SCHOLAR_FLUX_MCP_ENABLE_LOGGING=${SCHOLAR_FLUX_MCP_ENABLE_LOGGING} \
